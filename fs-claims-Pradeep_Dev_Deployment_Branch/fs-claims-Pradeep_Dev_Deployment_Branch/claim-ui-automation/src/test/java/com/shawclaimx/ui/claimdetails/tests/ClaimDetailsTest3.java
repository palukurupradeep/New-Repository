...
public class ClaimDetailsTest3 extends TestBaseSetup {
	...
	public void verifyClaimDetailsInVoiceTest() throws InterruptedException {
		...
		claimdetailspage.searchBarInvoiceNumberPage();
		claimdetailspage.selectinvoiceNumber();
		claimdetailspage.selectDuplicatelineiteminvoiceNumber();
		claimdetailspage.deleteLineIteminvoiceNumber();
